...
function init_db(): void {
    ...
    $migrations = [
        ...
        "ALTER TABLE `group_player` ADD COLUMN position INT NOT NULL DEFAULT 0",
        "ALTER TABLE `group_double` ADD COLUMN position INT NOT NULL DEFAULT 0",
        "ALTER TABLE `group_team`   ADD COLUMN position INT NOT NULL DEFAULT 0",
        "ALTER TABLE competition ADD COLUMN schedule_mode VARCHAR(10) NOT NULL DEFAULT 'random'",
        "ALTER TABLE `team` ADD COLUMN captain VARCHAR(255) NOT NULL DEFAULT ''",
        ...
        "ALTER TABLE grp ADD COLUMN pause_after_round INT NOT NULL DEFAULT 0",
        "ALTER TABLE grp ADD COLUMN pause_label VARCHAR(255) NOT NULL DEFAULT ''",
