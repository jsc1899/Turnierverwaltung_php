...
$routes = [
    ...
    ['POST',     '/competition/{id}/monitor-settings',        'competition', 'monitor_settings'],
    ...
    ['POST',     '/competition/{id}/draw/cross',             'competition', 'draw_cross'],
    ...
    ['GET', '/competition/{id}/pdf/court-plans',       'pdf', 'court_plans'],
    ['GET', '/competition/{id}/pdf/court-plans/{gid}',  'pdf', 'court_plans'],
